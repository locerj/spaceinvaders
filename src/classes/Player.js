import { INITIAL_FRAMES, PATH_EGINE_IMAGE, PATH_EGINE_SPRITES, PATH_SPACESHIP_IMAGE } from "../utils/constants.js";
...
class Player {
    constructor(canvasWidth, canvasHeight) {
        ...
        this.engineImage = this.getImage(PATH_EGINE_IMAGE);
        this.engineSprite = this.getImage(PATH_EGINE_SPRITES);
    ...
    draw(ctx) {
        ...
        ctx.drawImage(this.engineSprite, this.sx, 0, 48, 48, this.position.x, this.position.y + 10, this.width, this.height);
